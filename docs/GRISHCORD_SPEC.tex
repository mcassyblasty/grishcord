...
\subsection{Layouts}
Two responsive layouts are supported: (1) wide layout with left channel list and main chat panel; (2) portrait layout with channel list in a drawer/hamburger pattern and full-screen chat timeline.
\subsection{Themes}
...
Admin sets global slider 1--10. Exact enforced mapping:
\begin{center}
\begin{tabular}{rrrr}
\toprule
