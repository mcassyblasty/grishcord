...
\begin{itemize}
  ...
  \item \textbf{0.3.11--0.3.1}: Admin/sidebar/auth UX iterations, CSP-safe frontend script loading, and HTTP session-cookie reliability fixes.
\end{itemize}
