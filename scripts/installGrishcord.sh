...
main() {
  ...
  ROOT_ADMIN_USERNAME="$(prompt 'Root admin username' "${ROOT_ADMIN_USERNAME:-rootadmin}")"
...
2) Re-run installer any time: ./scripts/installGrishcord.sh (idempotent config in .install.env).
